...
.IMPORT EhBasic_Ram_base	; start of user RAM (set as needed, should be page aligned)
;Ram_top		= $C000	; end of user RAM+1 (set as needed, should be page aligned)
.IMPORT	EhBasic_Ram_top		; end of user RAM+1 (set as needed, should be page aligned)

Ram_base = EhBasic_Ram_base
Ram_top  = EhBasic_Ram_top
...
.EXPORT EhBasic_warm_start
EhBasic_warm_start = LAB_1274
...
LAB_1378:
	CPX	#.LOBYTE(Ibuffe-Ibuffs)	; compare character count with max
...
.IFDEF EHBASIC_PATCH_MIXED_CASE_KEYWORDS
.WARNING "Compiling 'mixed case keyword' patch in ..."
...
.IMPORT EhBasic_Ready_Prompt
LAB_RMSG = EhBasic_Ready_Prompt
